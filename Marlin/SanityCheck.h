 ...
 */
  ...
  + ENABLED(Z_RACK_PINION)                                                                                    //--------------------------ALE------------------------
  #error "Please enable only one probe option: PROBE_MANUALLY, FIX_MOUNTED_PROBE, BLTOUCH, SOLENOID_PROBE, Z_PROBE_ALLEN_KEY, Z_PROBE_SLED, Z_RACK_PINION, or Z Servo."                                                                                    //--------------------------ALE------------------------
#endif
